...
* Please note that rule exception definitions are **case-sensitive**. You need to configure the arguments exactly as they appear in the log lines as otherwise the rule exception won't match.
+
